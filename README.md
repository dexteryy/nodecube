...
Use nodecube-cli (TODO) or imitate the [example app](https://github.com/dexteryy/nodecube-example/) to create the minimal structure and configure files:
...
- [`package.json`](https://github.com/dexteryy/nodecube-example/blob/master/package.json) - Minimal dependencies and npm scripts based on ndoecube, see [nodecube-example's package.json](https://github.com/dexteryy/nodecube-example/blob/master/package.json)
- ... - See `Step 2`
